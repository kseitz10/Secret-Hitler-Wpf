using SecretHitler.Application;
using SecretHitler.Application.Common.Interfaces;
using SecretHitler.Infrastructure;
using SecretHitler.Infrastructure.Persistence;
using SecretHitler.WebUI.Filters;
using SecretHitler.WebUI.Services;
...
namespace SecretHitler.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configure.Title = "SecretHitler API";
