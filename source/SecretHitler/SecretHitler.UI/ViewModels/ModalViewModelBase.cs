...
namespace SecretHitler.UI.ViewModels
{
    ...
    public abstract class ModalViewModelBase : InteractionViewModelBase
    {
        ...
        /// </summary>
        protected internal virtual void RaiseCanExecuteCommands()
        {
        ...
        protected internal RelayCommand _acceptCommand;
        protected internal RelayCommand _cancelCommand;

        public ICommand AcceptCommand => _acceptCommand ??= new RelayCommand(Accept, CanExecuteAcceptCommand);

        public ICommand CancelCommand => _cancelCommand ??= new RelayCommand(Cancel, CanExecuteCancelCommand);
